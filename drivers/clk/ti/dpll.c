...
static int __init of_ti_dpll_setup(struct device_node *node,
				    ...
				    u8 init_flags, struct clk_reg_ops *reg_ops)
{
	struct clk *clk;
					  ...
					  struct clk_reg_ops *reg_ops)
{
	...
	clk = ti_clk_register_dpll_x2(node, &dpll_x2_ck_ops, NULL, reg_ops);
					       ...
					       struct clk_reg_ops *reg_ops)
{
	...
	return of_ti_dpll_setup(node, &dpll_no_gate_ck_ops, &dd, 0, reg_ops);
}
					     ...
					     struct clk_reg_ops *reg_ops)
{
        ...
        return of_ti_dpll_setup(node, &dpll_ck_ops, &dd, 0, reg_ops);
}
						     ...
						     struct clk_reg_ops *ops)
{
	...
	return of_ti_dpll_setup(node, &dpll_no_gate_ck_ops, &dd, 0, ops);
}
					    ...
					    struct clk_reg_ops *reg_ops)
{
	...
	return of_ti_dpll_setup(node, &dpll_core_ck_ops, &dd, 0, reg_ops);
}
