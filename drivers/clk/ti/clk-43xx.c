...
static const struct omap_clkctrl_reg_data am4_l4_wkup_aon_clkctrl_regs[] __initconst = {
	...
	{ AM4_L4_WKUP_AON_COUNTER_32K_CLKCTRL, am4_counter_32k_bit_data, CLKF_SW_SUP, "l4_wkup_aon_clkctrl:0008:8" },
	{ 0 },
};
...
static struct ti_dt_clk am43xx_clks[] = {
	...
	DT_CLK(NULL, "gpio0_dbclk", "l4_wkup_clkctrl:0148:8"),
	DT_CLK(NULL, "gpio1_dbclk", "l4ls_clkctrl:0058:8"),
	DT_CLK(NULL, "gpio2_dbclk", "l4ls_clkctrl:0060:8"),
	DT_CLK(NULL, "gpio3_dbclk", "l4ls_clkctrl:0068:8"),
	DT_CLK(NULL, "gpio4_dbclk", "l4ls_clkctrl:0070:8"),
	DT_CLK(NULL, "gpio5_dbclk", "l4ls_clkctrl:0078:8"),
	DT_CLK(NULL, "synctimer_32kclk", "l4_wkup_aon_clkctrl:0008:8"),
	DT_CLK(NULL, "usb_otg_ss0_refclk960m", "l3s_clkctrl:01f8:8"),
	DT_CLK(NULL, "usb_otg_ss1_refclk960m", "l3s_clkctrl:0200:8"),
	{ .node_name = NULL },
};
