...
static struct ti_dt_clk omap44xx_clks[] = {
	...
	DT_CLK(NULL, "dmic_sync_mux_ck", "abe_cm:0018:25"),
	...
	DT_CLK(NULL, "mcasp_sync_mux_ck", "abe_cm:0020:25"),
	DT_CLK(NULL, "mcbsp1_sync_mux_ck", "abe_cm:0028:25"),
	DT_CLK(NULL, "mcbsp2_sync_mux_ck", "abe_cm:0030:25"),
	DT_CLK(NULL, "mcbsp3_sync_mux_ck", "abe_cm:0038:25"),
	DT_CLK(NULL, "mcbsp4_sync_mux_ck", "l4_per_cm:00c0:25"),
