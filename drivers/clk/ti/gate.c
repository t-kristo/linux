...
{
	return _of_ti_composite_gate_clk_setup(node, NULL, ops);
}
...
static int __init of_ti_composite_interface_clk_setup(struct device_node *node,
						      struct clk_reg_ops *ops)
{
	return _of_ti_composite_gate_clk_setup(node, &clkhwops_iclk_wait, ops);
}
...
static int __init of_ti_composite_gate_clk_setup(struct device_node *node,
						 struct clk_reg_ops *ops)
{
	return _of_ti_composite_gate_clk_setup(node, &clkhwops_wait, ops);
}
...
static int __init of_ti_gate_clk_setup(struct device_node *node,
				       struct clk_reg_ops *reg_ops)
{
	return _of_ti_gate_clk_setup(node, &omap_gate_clk_ops, NULL, reg_ops);
}
