...
static const char * const am3_trace_pmd_clk_mux_ck_parents[] __initconst = {
	"l3_aon_clkctrl:0000:19",
	"l3_aon_clkctrl:0000:30",
	NULL,
};

static const char * const am3_trace_clk_div_ck_parents[] __initconst = {
	"l3_aon_clkctrl:0000:20",
	NULL,
};
...
static const struct omap_clkctrl_reg_data am3_l3_aon_clkctrl_regs[] __initconst = {
	{ AM3_L3_AON_DEBUGSS_CLKCTRL, am3_debugss_bit_data, CLKF_SW_SUP, "l3_aon_clkctrl:0000:24" },
	{ 0 },
};
...
static struct ti_dt_clk am33xx_clks[] = {
	DT_CLK(NULL, "timer_32k_ck", "clk_24mhz_clkctrl:0000:0"),
	DT_CLK(NULL, "timer_sys_ck", "sys_clkin_ck"),
	DT_CLK(NULL, "clkdiv32k_ick", "clk_24mhz_clkctrl:0000:0"),
	DT_CLK(NULL, "dbg_clka_ck", "l3_aon_clkctrl:0000:30"),
	DT_CLK(NULL, "dbg_sysclk_ck", "l3_aon_clkctrl:0000:19"),
	DT_CLK(NULL, "gpio0_dbclk", "l4_wkup_clkctrl:0008:18"),
	DT_CLK(NULL, "gpio1_dbclk", "l4ls_clkctrl:0074:18"),
	DT_CLK(NULL, "gpio2_dbclk", "l4ls_clkctrl:0078:18"),
	DT_CLK(NULL, "gpio3_dbclk", "l4ls_clkctrl:007c:18"),
	DT_CLK(NULL, "stm_clk_div_ck", "l3_aon_clkctrl:0000:27"),
	DT_CLK(NULL, "stm_pmd_clock_mux_ck", "l3_aon_clkctrl:0000:22"),
	DT_CLK(NULL, "trace_clk_div_ck", "l3_aon_clkctrl:0000:24"),
	DT_CLK(NULL, "trace_pmd_clk_mux_ck", "l3_aon_clkctrl:0000:20"),
	{ .node_name = NULL },
};
