 ...
 */
#ifndef __LINUX_POWER_OMAP_PRM_REGBITS_34XX_H
#define __LINUX_POWER_OMAP_PRM_REGBITS_34XX_H
...
#define OMAP3430_TIMEOUTEN_MASK				BIT(3)
#define OMAP3430_INITVDD_MASK				BIT(2)
#define OMAP3430_FORCEUPDATE_MASK			BIT(1)
#define OMAP3430_VPENABLE_MASK				BIT(0)
...
#define OMAP3430_LOGICSTATEST_MASK			BIT(2)
#define OMAP3430_LASTLOGICSTATEENTERED_MASK		BIT(2)
#define OMAP3430_LASTPOWERSTATEENTERED_MASK		(0x3 << 0)
#define OMAP3430_GRPSEL_MCBSP5_MASK			BIT(10)
#define OMAP3430_GRPSEL_MCBSP1_MASK			BIT(9)
#define OMAP3630_GRPSEL_UART4_MASK			BIT(18)
#define OMAP3430_GRPSEL_GPIO6_MASK			BIT(17)
#define OMAP3430_GRPSEL_GPIO5_MASK			BIT(16)
#define OMAP3430_GRPSEL_GPIO4_MASK			BIT(15)
#define OMAP3430_GRPSEL_GPIO3_MASK			BIT(14)
#define OMAP3430_GRPSEL_GPIO2_MASK			BIT(13)
#define OMAP3430_GRPSEL_UART3_MASK			BIT(11)
#define OMAP3430_GRPSEL_GPT8_MASK			BIT(9)
#define OMAP3430_GRPSEL_GPT7_MASK			BIT(8)
#define OMAP3430_GRPSEL_GPT6_MASK			BIT(7)
#define OMAP3430_GRPSEL_GPT5_MASK			BIT(6)
#define OMAP3430_GRPSEL_MCBSP4_MASK			BIT(2)
#define OMAP3430_GRPSEL_MCBSP3_MASK			BIT(1)
#define OMAP3430_GRPSEL_MCBSP2_MASK			BIT(0)
#define OMAP3430_GRPSEL_GPIO1_MASK			BIT(3)
#define OMAP3430_GRPSEL_GPT12_MASK			BIT(1)
#define OMAP3430_GRPSEL_GPT1_MASK			BIT(0)
#define OMAP3430_RST3_IVA2_MASK				BIT(2)
#define OMAP3430_RST2_IVA2_MASK				BIT(1)
#define OMAP3430_RST1_IVA2_MASK				BIT(0)
...
#define OMAP3430_L2FLATMEMRETSTATE_MASK			BIT(11)
#define OMAP3430_SHAREDL2CACHEFLATRETSTATE_MASK		BIT(10)
#define OMAP3430_L1FLATMEMRETSTATE_MASK			BIT(9)
#define OMAP3430_SHAREDL1CACHEFLATRETSTATE_MASK		BIT(8)
...
#define OMAP3430_VP2_TRANXDONE_ST_MASK			BIT(21)
#define OMAP3430_VP1_TRANXDONE_ST_MASK			BIT(15)
...
#define OMAP3430_RM_RSTCTRL_CORE_MODEM_SW_RSTPWRON_MASK		BIT(1)
#define OMAP3430_RM_RSTCTRL_CORE_MODEM_SW_RST_MASK		BIT(0)
#define OMAP3430_LASTMEM2STATEENTERED_MASK		(0x3 << 6)
#define OMAP3430_LASTMEM1STATEENTERED_MASK		(0x3 << 4)
#define OMAP3430_EN_IO_CHAIN_MASK			BIT(16)
#define OMAP3430_EN_IO_MASK				BIT(8)
#define OMAP3430_EN_GPIO1_MASK				BIT(3)
#define OMAP3430_ST_IO_CHAIN_MASK			BIT(16)
#define OMAP3430_ST_IO_MASK				BIT(8)
#define OMAP3430_SYS_CLKIN_SEL_SHIFT			0
#define OMAP3430_SYS_CLKIN_SEL_WIDTH			3
#define OMAP3430_CLKOUT_EN_SHIFT			7
#define OMAP3430_PM_WKEN_DSS_EN_DSS_MASK		BIT(0)
...
#define OMAP3430_HSEN_MASK				BIT(3)
#define OMAP3430_MCODE_MASK				(0x7 << 0)
#define OMAP3430_VALID_MASK				BIT(24)
...
#define OMAP3430_GLOBAL_COLD_RST_MASK			BIT(0)
#define OMAP3430_PRM_VOLTCTRL_SEL_VMODE			BIT(4)
#define OMAP3430_PRM_VOLTCTRL_SEL_OFF			BIT(3)
#define OMAP3430_PRM_VOLTCTRL_AUTO_OFF			BIT(2)
#define OMAP3430_PRM_VOLTCTRL_AUTO_RET			BIT(1)
#define OMAP3430_PRM_VOLTCTRL_AUTO_SLEEP		BIT(0)
#define OMAP3430_SETUP_TIME2_MASK			(0xffff << 16)
#define OMAP3430_SETUP_TIME1_MASK			(0xffff << 0)
#define OMAP3430_PRM_POLCTRL_OFFMODE_POL		BIT(3)
#define OMAP3430_PRM_POLCTRL_CLKOUT_POL			BIT(2)
#define OMAP3430_PRM_POLCTRL_CLKREQ_POL			BIT(1)
#define OMAP3430_PRM_POLCTRL_EXTVOL_POL			BIT(0)
#endif
