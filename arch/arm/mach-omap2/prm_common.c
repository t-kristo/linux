...
/**
 * prm_clear_mod_irqs - clear wake-up events from PRCM interrupt
...
/**
 * prm_vp_check_txdone - check voltage processor TX done status
 *
...
/**
 * prm_vp_clear_txdone - clears voltage processor TX done status
 *
