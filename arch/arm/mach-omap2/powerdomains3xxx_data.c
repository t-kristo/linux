...
void __init omap3xxx_powerdomains_init(void)
{
	...
	if (rev == AM35XX_REV_ES1_0 || rev == AM35XX_REV_ES1_1) {
		...
		if (pds)
			omap_pwrdm_register_pwrdms(pds);
	}
