...
#include "omap_hwmod_common_data.c"
#include "omap_hwmod_common_ipblock_data.c"
#include "omap_hwmod_2xxx_3xxx_ipblock_data.c"
#include "omap_hwmod_2xxx_3xxx_interconnect_data.c"
#endif
...
static int __init omap3_hwmod_data_probe(struct platform_device *pdev)
{
	...
	omap_pdata_quirks_init(omap3_hwmod_data_match);
...
static int __init omap3_hwmod_data_driver_init(void)
{
	if (!of_machine_is_compatible("ti,omap3")) {
		pr_err("Unsupported machine, aborted.\n");
		return -ENODEV;
	}
...
//module_platform_driver_probe(omap3_hwmod_data_driver, omap3_hwmod_data_probe);
