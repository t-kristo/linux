...
static int __init omap3_hwmod_data_probe(struct platform_device *pdev)
{
	...
	omap2_dss_hwmod_class.reset = hwmod_ptrs[OMAP_HWMOD_PTR_DSS_RESET];
	omap2_hdq1w_class.reset = hwmod_ptrs[OMAP_HWMOD_PTR_HDQ1W_RESET];
	i2c_class.reset = hwmod_ptrs[OMAP_HWMOD_PTR_I2C_RESET];
	omap3xxx_wd_timer_hwmod_class.pre_shutdown =
		hwmod_ptrs[OMAP_HWMOD_PTR_WD_TIMER_DIS];
	omap3xxx_wd_timer_hwmod_class.reset =
		hwmod_ptrs[OMAP_HWMOD_PTR_WD_TIMER_RESET];
